...
export async function POST(req) 
{
    try
    {
        ...
        const { name, email, phone, imageURL, about, experience, linkedin }  = await req.json(); 
        ...
        await mentorInstance.addNewMentor(name, email, phone, uploadURL, about, experience, linkedin);
